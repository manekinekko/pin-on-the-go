...
class _View_TabsPage_Host0 extends import1.AppView<any> {
  ...
  detectChangesInternal(throwOnChange:boolean):void {
    if (((this.numberOfChecks === 0) && !throwOnChange)) { this._TabsPage_0_4.ngOnInit(); }
...
function viewFactory_TabsPage_Host0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<any> {
  if ((renderType_TabsPage_Host === (null as any))) { (renderType_TabsPage_Host = viewUtils.createRenderComponentType('',0,import10.ViewEncapsulation.None,[],{})); }
  return new _View_TabsPage_Host0(viewUtils,parentInjector,declarationEl);
}
export const TabsPageNgFactory:import11.ComponentFactory<import3.TabsPage> = new import11.ComponentFactory<import3.TabsPage>('ng-component',viewFactory_TabsPage_Host0,import3.TabsPage);
...
class _View_TabsPage0 extends import1.AppView<import3.TabsPage> {
  ...
  _el_0:any;
  /*private*/ _appEl_0:import2.AppElement;
  _Tabs_0_4:import13.Tabs;
  _text_1:any;
  _el_2:any;
  /*private*/ _appEl_2:import2.AppElement;
  _Tab_2_4:import14.Tab;
  _text_3:any;
  _el_4:any;
  /*private*/ _appEl_4:import2.AppElement;
  _Tab_4_4:import14.Tab;
  _text_5:any;
  _text_6:any;
  /*private*/ _expr_0:any;
  /*private*/ _expr_1:any;
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    var compView_2:any = import23.viewFactory_Tab0(this.viewUtils,this.injector(2),this._appEl_2);
    this._Tab_2_4 = new import14.Tab(this._Tabs_0_4,this.parentInjector.get(import18.App),this.parentInjector.get(import19.Config),this.parentInjector.get(import24.Keyboard),new import20.ElementRef(this._el_2),this.parentInjector.get(import25.NgZone),this.renderer,this.parentInjector.get(import26.ComponentFactoryResolver),compView_2.ref,this.parentInjector.get(import27.GestureController),this.parentInjector.get(import28.TransitionController),this.parentInjector.get(import22.DeepLinker,(null as any)));
    ...
    var compView_4:any = import23.viewFactory_Tab0(this.viewUtils,this.injector(4),this._appEl_4);
    this._Tab_4_4 = new import14.Tab(this._Tabs_0_4,this.parentInjector.get(import18.App),this.parentInjector.get(import19.Config),this.parentInjector.get(import24.Keyboard),new import20.ElementRef(this._el_4),this.parentInjector.get(import25.NgZone),this.renderer,this.parentInjector.get(import26.ComponentFactoryResolver),compView_4.ref,this.parentInjector.get(import27.GestureController),this.parentInjector.get(import28.TransitionController),this.parentInjector.get(import22.DeepLinker,(null as any)));
  ...
  injectorGetInternal(token:any,requestNodeIndex:number,notFoundResult:any):any {
    if (((token === import14.Tab) && (2 === requestNodeIndex))) { return this._Tab_2_4; }
    if (((token === import14.Tab) && (4 === requestNodeIndex))) { return this._Tab_4_4; }
    if (((token === import13.Tabs) && ((0 <= requestNodeIndex) && (requestNodeIndex <= 5)))) { return this._Tabs_0_4; }
    return notFoundResult;
  }
  detectChangesInternal(throwOnChange:boolean):void {
    ...
    const currVal_1:any = this.context.tab0Root;
    ...
    const currVal_7:any = this.context.isLoggedIn;
...
export function viewFactory_TabsPage0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.TabsPage> {
  if ((renderType_TabsPage === (null as any))) { (renderType_TabsPage = viewUtils.createRenderComponentType('/Users/wassimchegham/Sandbox/oss/pin-on-the-go/.tmp/pages/tabs/tabs.html',0,import10.ViewEncapsulation.None,styles_TabsPage,{})); }
