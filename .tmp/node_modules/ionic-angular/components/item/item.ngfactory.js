...
export function viewFactory_Item0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_Item === null)) {
        (renderType_Item = viewUtils.createRenderComponentType('/Users/wassimchegham/Sandbox/oss/pin-on-the-go/node_modules/ionic-angular/components/item/item.d.ts class Item - inline template', 5, import12.ViewEncapsulation.None, styles_Item, {}));
    }
