...
export function viewFactory_ModalCmp0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_ModalCmp === null)) {
        (renderType_ModalCmp = viewUtils.createRenderComponentType('/Users/wassimchegham/Sandbox/oss/pin-on-the-go/node_modules/ionic-angular/components/modal/modal-component.d.ts class ModalCmp - inline template', 0, import11.ViewEncapsulation.None, styles_ModalCmp, {}));
    }
