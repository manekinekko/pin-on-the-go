...
export function viewFactory_TextInput0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.TextInput> {
  if ((renderType_TextInput === (null as any))) { (renderType_TextInput = viewUtils.createRenderComponentType('/Users/wassimchegham/Sandbox/oss/pin-on-the-go/node_modules/ionic-angular/components/input/input.d.ts class TextInput - inline template',0,import17.ViewEncapsulation.None,styles_TextInput,{})); }
...
export function viewFactory_TextArea0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.TextArea> {
  if ((renderType_TextArea === (null as any))) { (renderType_TextArea = viewUtils.createRenderComponentType('/Users/wassimchegham/Sandbox/oss/pin-on-the-go/node_modules/ionic-angular/components/input/input.d.ts class TextArea - inline template',0,import17.ViewEncapsulation.None,styles_TextArea,{})); }
