...
export function viewFactory_Tab0(viewUtils:import4.ViewUtils,parentInjector:import5.Injector,declarationEl:import2.AppElement):import1.AppView<import3.Tab> {
  if ((renderType_Tab === (null as any))) { (renderType_Tab = viewUtils.createRenderComponentType('/Users/wassimchegham/Sandbox/oss/pin-on-the-go/node_modules/ionic-angular/components/tabs/tab.d.ts class Tab - inline template',0,import18.ViewEncapsulation.None,styles_Tab,{})); }
