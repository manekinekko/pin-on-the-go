...
export function viewFactory_Spinner0(viewUtils, parentInjector, declarationEl) {
    if ((renderType_Spinner === null)) {
        (renderType_Spinner = viewUtils.createRenderComponentType('/Users/wassimchegham/Sandbox/oss/pin-on-the-go/node_modules/ionic-angular/components/spinner/spinner.d.ts class Spinner - inline template', 0, import10.ViewEncapsulation.None, styles_Spinner, {}));
    }
